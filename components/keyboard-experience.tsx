...
export function KeyboardExperience() {
  ...
  return (
    <main className="relative min-h-svh w-full overflow-hidden bg-black">
      ...
      <section className="absolute inset-x-0 bottom-[clamp(58px,8vh,78px)] top-[clamp(188px,25vh,220px)] z-10 overflow-hidden bg-[radial-gradient(ellipse_34%_53%_at_50%_55%,#191919_0%,#0b0b0b_38%,#000_76%)]" aria-label="Interactive 3D WASD keyboard">
